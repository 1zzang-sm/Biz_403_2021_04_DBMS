...
--   마치 excel의 sheet에 데이터를 저장하는 것 처럼
--   데이터가 저장된다.
...
-- TABLEdms Java 코딩에서 VO 클래스를 만드는 원리와 비슷하다.
...
CREATE TABLE tbl_score (
    ...
    sc_name nVARCHAR2(20), -- 가변 문자열, String name 
    sc_kor NUMBER,
    sc_eng NUMBER,
    sc_math NUMBER
);
